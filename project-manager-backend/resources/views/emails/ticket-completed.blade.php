...
<head>
  ...
  <title>Ticket đã hoàn thành</title>
</head>
<body style="font-family:Arial,sans-serif;background:#f8fafc;color:#1f2937;padding:20px;">
  <div style="max-width:640px;margin:0 auto;background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:20px;">
    <h2 style="margin:0 0 12px;color:#111827;">Ticket của bạn đã được hoàn thành</h2>
    ...
    <p>Bạn có thể xem chi tiết ticket tại link sau:</p>
    <p><a href="{{ $publicTicketUrl }}" style="color:#2563eb;">{{ $publicTicketUrl }}</a></p>
  </div>
</body>
</html>
